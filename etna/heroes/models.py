...
class HeroImageMixin(models.Model):
    ...
    hero_image_alt_text = models.CharField(max_length=100, blank=True, help_text=
    format_html("%s <a href=%s target=%s>%s</a>." % (
    ...
    hero_image_caption = RichTextField(features=['link'], blank=True, help_text="An optional caption for non-decorative images, which will be displayed directly below the image. This could be used for image sources or for other useful metadata.")
